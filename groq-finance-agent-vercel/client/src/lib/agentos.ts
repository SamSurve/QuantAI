...
const DEFAULT_API_URL = import.meta.env.VITE_AGENTOS_API_URL || "/api";
...
function friendlyAgentError(value: unknown, status?: number) {
  ...
  if (
    ...
    return "AI analysis is temporarily unavailable because the Groq service is busy. Please wait a few minutes and try again; the dashboard is ready for your next request.";
  }
